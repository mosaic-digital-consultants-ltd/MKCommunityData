...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyBuZG8QnItRMSpVlZkemQf7xtKqEC4_SWM'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center						= '51.384880, -2.361970';		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	var $map_height					= "830px";					// The height of the map container. Any units (ie 'px') can be used. If no units are provided 'px' will be presumed
	...
	function get_lat_long_from_address($address, $attempts = 0)
	{
		...
		$data_location .= "maps.google.com/maps/api/geocode/json?address=".urlencode(utf8_encode($address));
