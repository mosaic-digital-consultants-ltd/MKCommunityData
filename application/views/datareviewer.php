<div class="testbox" xmlns="http://www.w3.org/1999/html">
    <form action="/MKForm/submit" method="POST">
        <div class="banner">
            <h1>Community Action MK - Admin Tools: Form Reviewer</h1>
        </div>
...
<script>
    ...
    $(document).ready(function() {
        var msg_prompt = "";
        $("button.fn-edit").on('click', function() {

            window.location.href = "/admin/MKFormEdit?iss=" +  + $(this).attr('data-issue-num');
        });

    $("button.fn-approve").on('click', function() {

        //alert("approving " + $(this).attr('data-issue-num'));
        params = "s=y&iss=" + $(this).attr('data-issue-num');


            $.ajax({
                url: "/admin/MKReview/approve",
                type: "POST",
                data:params,
                dataType: "json",
